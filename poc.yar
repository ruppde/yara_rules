...
private rule capa_allocate_memory { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /VirtualAlloc/) 
	or 	pe.imports(/kernel32.dll/i, /VirtualAllocEx/) 
...
private rule capa_delay_execution { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /Sleep/) 
	or 	pe.imports(/kernel32.dll/i, /SleepEx/) 
	or 	pe.imports(/kernel32.dll/i, /WaitForSingleObject/) 
	or 	pe.imports(/kernel32.dll/i, /SignalObjectAndWait/) 
	or 	pe.imports(/kernel32.dll/i, /WaitForSingleObjectEx/) 
...
private rule capa_timestomp_file { 
 ...
 (  (  ( 	pe.imports(/kernel32.dll/i, /GetSystemTime/) 
	or 	pe.imports(/kernel32.dll/i, /FileTimeToLocalFileTime/) 
	or 	pe.imports(/kernel32.dll/i, /GetSystemTimeAsFileTime/) 
	or 	pe.imports(/kernel32.dll/i, /SystemTimeToFileTime/) 
	or 	pe.imports(/kernel32.dll/i, /GetFileTime/)  )  ) 
	and 	pe.imports(/kernel32.dll/i, /SetFileTime/)  ) 
}
...
private rule capa_clear_the_Windows_event_log { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /ElfClearEventLogFile/)  ) 
}
...
private rule capa_check_for_debugger_via_API { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /CheckRemoteDebuggerPresent/) 
	or 	pe.imports(/wudfplatform.dll/i, /WudfIsAnyDebuggerPresent/) 
	or 	pe.imports(/wudfplatform.dll/i, /WudfIsKernelDebuggerPresent/) 
	or 	pe.imports(/wudfplatform.dll/i, /WudfIsUserDebuggerPresent/)  ) 
}
...
private rule capa_check_for_OutputDebugString_error { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /SetLastError/) 
	and 	pe.imports(/kernel32.dll/i, /GetLastError/) 
	and 	pe.imports(/kernel32.dll/i, /OutputDebugString/)  ) 
}
...
private rule capa_create_thread { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /CreateThread/) 
	...
	or 	pe.imports(/ntdll.dll/i, /NtCreateThread/) 
	or 	pe.imports(/ntdll.dll/i, /NtCreateThreadEx/) 
	or 	pe.imports(/ntdll.dll/i, /ZwCreateThread/) 
	or 	pe.imports(/ntdll.dll/i, /ZwCreateThreadEx/)  ) 
}
...
private rule capa_resume_thread { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /ResumeThread/) 
	or 	pe.imports(/ntdll.dll/i, /NtResumeThread/) 
	or 	pe.imports(/ntdll.dll/i, /ZwResumeThread/)  ) 
}
...
private rule capa_suspend_thread { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /SuspendThread/) 
	or 	pe.imports(/ntdll.dll/i, /NtSuspendThread/) 
	or 	pe.imports(/ntdll.dll/i, /ZwSuspendThread/)  ) 
}
...
private rule capa_manipulate_console { 
 ...
 (  (  ( 	pe.imports(/kernel32.dll/i, /SetConsoleCursorPosition/) 
	or 	pe.imports(/kernel32.dll/i, /ReadConsoleOutputCharacter/) 
	or 	pe.imports(/kernel32.dll/i, /WriteConsoleOutputCharacter/) 
	or 	pe.imports(/kernel32.dll/i, /WriteConsoleOutput/) 
	or 	pe.imports(/kernel32.dll/i, /WriteConsoleInput/)  )  )  ) 
}
...
private rule capa_access_firewall_settings_via_INetFwMgr { 
 ...
 ( 	pe.imports(/ole32.dll/i, /CoCreateInstance/) 
	and 	$akh 
	and 	$aki  ) 
}
...
private rule capa_get_common_file_path { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /GetTempPath/) 
	or 	pe.imports(/kernel32.dll/i, /GetTempFileName/) 
	...
	or 	pe.imports(/shell32.dll/i, /SHGetSpecialFolderLocation/)  ) 
}
...
private rule capa_enumerate_files_via_kernel32_functions { 
 ...
 (  (  ( 	pe.imports(/kernel32.dll/i, /FindFirstFile/) 
	or 	pe.imports(/kernel32.dll/i, /FindFirstFileEx/) 
	or 	pe.imports(/kernel32.dll/i, /FindFirstFileTransacted/) 
	or 	pe.imports(/kernel32.dll/i, /FindFirstFileName/) 
	or 	pe.imports(/kernel32.dll/i, /FindFirstFileNameTransacted/)  )  ) 
	and  (  ( 	pe.imports(/kernel32.dll/i, /FindNextFile/) 
	or 	pe.imports(/kernel32.dll/i, /FindNextFileName/)  )  )  ) 
}
...
private rule capa_shutdown_system { 
 ...
 ( 	pe.imports(/user32.dll/i, /ExitWindowsEx/) 
	or 	pe.imports(/user32.dll/i, /ExitWindows/)  ) 
}
...
private rule capa_query_service_status { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /QueryServiceStatusEx/) 
	or 	pe.imports(/advapi32.dll/i, /QueryServiceStatus/)  ) 
}
...
private rule capa_delete_service { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /DeleteService/)  ) 
}
...
private rule capa_enumerate_services { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /EnumServicesStatus/) 
	or 	pe.imports(/advapi32.dll/i, /EnumServicesStatusEx/)  ) 
}
...
private rule capa_create_service { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /CreateService/)  ) 
}
...
private rule capa_modify_service { 
 ...
 (  (  ( 	pe.imports(/advapi32.dll/i, /ChangeServiceConfig/) 
	or 	pe.imports(/advapi32.dll/i, /ChangeServiceConfig2/)  )  )  ) 
}
...
private rule capa_start_service { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /StartService/)  ) 
}
...
private rule capa_get_disk_information { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /GetDriveType/) 
	or 	pe.imports(/kernel32.dll/i, /GetLogicalDrives/) 
	or 	pe.imports(/kernel32.dll/i, /GetVolumeInformation/) 
	or 	pe.imports(/kernel32.dll/i, /GetVolumeNameForVolumeMountPoint/) 
	or 	pe.imports(/kernel32.dll/i, /GetVolumePathNamesForVolumeName/) 
	or 	pe.imports(/kernel32.dll/i, /GetLogicalDriveStrings/) 
	or 	pe.imports(/kernel32.dll/i, /QueryDosDevice/)  ) 
}
...
private rule capa_manipulate_CD_ROM_drive { 
 ...
 ( 	pe.imports(/winmm.dll/i, /mciSendString/) 
	and  (  ( 	$str_ako 
	or 	$str_akp  )  )  ) 
}
...
private rule capa_get_memory_capacity { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /GlobalMemoryStatus/) 
	or 	pe.imports(/kernel32.dll/i, /GlobalMemoryStatusEx/)  ) 
}
...
private rule capa_swap_mouse_buttons { 
 ...
 ( 	pe.imports(/user32.dll/i, /SwapMouseButton/)  ) 
}
...
private rule capa_get_keyboard_layout { 
 ...
 (  (  ( 	pe.imports(/user32.dll/i, /GetKeyboardLayoutList/) 
	or 	pe.imports(/user32.dll/i, /GetKeyboardLayout/) 
	or 	pe.imports(/user32.dll/i, /GetKeyboardLayoutName/)  )  )  ) 
}
...
private rule capa_open_clipboard { 
 ...
 ( 	pe.imports(/user32.dll/i, /OpenClipboard/)  ) 
}
...
private rule capa_write_clipboard_data { 
 ...
 ( 	pe.imports(/user32.dll/i, /SetClipboardData/)  ) 
}
...
private rule capa_read_clipboard_data { 
 ...
 ( 	pe.imports(/user32.dll/i, /GetClipboardData/)  ) 
}
...
private rule capa_replace_clipboard_data { 
 ...
 ( 	capa_write_clipboard_data
	...
	and 	pe.imports(/user32.dll/i, /EmptyClipboard/)  ) 
}
...
private rule capa_set_application_hook { 
 ...
 (  (  ( 	pe.imports(/user32.dll/i, /SetWindowsHookEx/) 
	or 	pe.imports(/user32.dll/i, /UnhookWindowsHookEx/)  )  )  ) 
}
...
private rule capa_find_graphical_window { 
 ...
 ( 	pe.imports(/user32.dll/i, /FindWindow/) 
	or 	pe.imports(/user32.dll/i, /FindWindowEx/)  ) 
}
...
private rule capa_lock_the_desktop { 
  ...
  condition: 
	...
	pe.imports(/user32.dll/i, /LockWorkStation/) 
}
...
private rule capa_resolve_path_using_msvcrt { 
 ...
 ( 	pe.imports(/msvcrt.dll/i, /__p__pgmptr/) 
	or 	pe.imports(/msvcrt.dll/i, /__p__wpgmptr/) 
	or 	pe.imports(/msvcrt.dll/i, /_get_pgmptr/) 
	or 	pe.imports(/msvcrt.dll/i, /_get_wpgmptr/) 
	or 	pe.imports(/msvcrt.dll/i, /_pgmptr/) 
	or 	pe.imports(/msvcrt.dll/i, /_wpgmptr/)  ) 
}
...
private rule capa_set_thread_local_storage_value { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /TlsSetValue/)  ) 
}
...
private rule capa_allocate_thread_local_storage { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /TlsAlloc/)  ) 
}
...
private rule capa_attach_user_process_memory { 
 ...
 ( 	pe.imports(/ntoskrnl.dll/i, /KeStackAttachProcess/) 
	and 	pe.imports(/ntoskrnl.dll/i, /KeUnstackDetachProcess/)  ) 
}
...
private rule capa_inject_APC { 
 ...
 (  (  ( 	capa_write_process_memory
	...
	or 	pe.imports(/ntdll.dll/i, /NtQueueApcThread/)  )  )  ) 
}
...
private rule capa_enumerate_processes { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /Process32First/) 
	and 	pe.imports(/kernel32.dll/i, /Process32Next/)  ) 
}
...
private rule capa_enumerate_processes_on_remote_desktop_session_host { 
 ...
 (  (  ( 	pe.imports(/wtsapi32.dll/i, /WTSEnumerateProcesses/) 
	or 	pe.imports(/wtsapi32.dll/i, /WTSEnumerateProcessesEx/)  )  )  ) 
}
...
private rule capa_find_process_by_PID { 
 ...
 ( 	pe.imports(/ntoskrnl.dll/i, /PsLookupProcessByProcessId/)  ) 
}
...
private rule capa_create_process { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /WinExec/) 
	or 	pe.imports(/kernel32.dll/i, /CreateProcess/) 
	or 	pe.imports(/shell32.dll/i, /ShellExecute/) 
	or 	pe.imports(/shell32.dll/i, /ShellExecuteEx/) 
	or 	pe.imports(/advapi32.dll/i, /CreateProcessAsUser/) 
	or 	pe.imports(/advapi32.dll/i, /CreateProcessWithLogon/) 
	or 	pe.imports(/advapi32.dll/i, /CreateProcessWithToken/) 
	or 	pe.imports(/kernel32.dll/i, /CreateProcessInternal/) 
	or 	pe.imports(/ntdll.dll/i, /NtCreateUserProcess/) 
...
private rule capa_modify_access_privileges { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /AdjustTokenPrivileges/)  ) 
}
...
private rule capa_terminate_process { 
 ...
 (  (  ( 	pe.imports(/kernel32.dll/i, /TerminateProcess/) 
	or 	pe.imports(/ntdll.dll/i, /NtTerminateProcess/) 
	or 	pe.imports(/kernel32.dll/i, /ExitProcess/)  )  )  ) 
}
...
private rule capa_get_domain_information { 
  ...
  condition: 
	...
	pe.imports(/netapi32.dll/i, /DsRoleGetPrimaryDomainInformation/) 
}
...
private rule capa_get_networking_interfaces { 
 ...
 ( 	pe.imports(/iphlpapi.dll/i, /GetIfTable/) 
	or 	pe.imports(/iphlpapi.dll/i, /GetAdaptersInfo/)  ) 
}
...
private rule capa_register_network_filter_via_WFP_API { 
 ...
 ( 	pe.imports(/fwpkclnt.dll/i, /FwpmFilterAdd0/)  ) 
}
...
private rule capa_copy_network_traffic { 
 ...
 ( 	pe.imports(/fwpkclnt.dll/i, /FwpsCopyStreamDataToBuffer0/)  ) 
}
...
private rule capa_check_Internet_connectivity_via_WinINet { 
 ...
 (  (  ( 	pe.imports(/wininet.dll/i, /InternetGetConnectedState/) 
	or 	pe.imports(/wininet.dll/i, /InternetCheckConnection/)  )  )  ) 
}
...
private rule capa_create_mutex { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /CreateMutex/) 
	or 	pe.imports(/kernel32.dll/i, /CreateMutexEx/)  ) 
}
...
private rule capa_print_debug_messages { 
 ...
 ( 	pe.imports(/ntoskrnl.dll/i, /DbgPrint/) 
	or 	pe.imports(/kernel32.dll/i, /OutputDebugString/)  ) 
}
...
private rule capa_set_environment_variable { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /SetEnvironmentStrings/) 
	or 	pe.imports(/kernel32.dll/i, /SetEnvironmentVariable/)  ) 
}
...
private rule capa_query_environment_variable { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /GetEnvironmentVariable/) 
	or 	pe.imports(/kernel32.dll/i, /GetEnvironmentStrings/) 
	or 	pe.imports(/kernel32.dll/i, /ExpandEnvironmentStrings/) 
	or 	pe.imports(/msvcr90.dll/i, /getenv/) 
	or 	pe.imports(/msvcrt.dll/i, /getenv/)  ) 
}
...
private rule capa_query_or_enumerate_registry_value { 
 ...
 (  (  ( 	pe.imports(/advapi32.dll/i, /RegGetValue/) 
	or 	pe.imports(/advapi32.dll/i, /RegEnumValue/) 
...
private rule capa_create_or_open_registry_key { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /RegOpenKey/) 
	or 	pe.imports(/advapi32.dll/i, /RegOpenKeyEx/) 
	or 	pe.imports(/advapi32.dll/i, /RegCreateKey/) 
	or 	pe.imports(/advapi32.dll/i, /RegCreateKeyEx/) 
	or 	pe.imports(/advapi32.dll/i, /RegOpenCurrentUser/) 
...
private rule capa_delete_registry_key { 
 ...
 (  (  ( 	pe.imports(/advapi32.dll/i, /RegDeleteKey/) 
...
private rule capa_get_logon_sessions { 
 ...
 ( 	pe.imports(/secur32.dll/i, /LsaEnumerateLogonSessions/)  ) 
}
...
private rule capa_get_session_integrity_level { 
 ...
 ( 	pe.imports(/shell32.dll/i, /IsUserAnAdmin/)  ) 
}
...
private rule capa_link_function_at_runtime { 
 ...
 (  (  ( 	pe.imports(/kernel32.dll/i, /LoadLibrary/) 
	or 	pe.imports(/kernel32.dll/i, /GetModuleHandle/) 
	or 	pe.imports(/kernel32.dll/i, /GetModuleHandleEx/) 
	or 	pe.imports(/ntdll.dll/i, /LdrLoadDll/)  )  ) 
	and  (  ( 	pe.imports(/kernel32.dll/i, /GetProcAddress/) 
	or 	pe.imports(/ntdll.dll/i, /LdrGetProcedureAddress/)  )  )  ) 
}
...
private rule capa_import_public_key { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /CryptAcquireContext/) 
	and 	pe.imports(/crypt32.dll/i, /CryptImportPublicKeyInfo/)  ) 
}
...
private rule capa_hash_data_via_WinCrypt { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /CryptHashData/)  ) 
}
...
private rule capa_compiled_to_the__NET_platform { 
 ...
 ( 	pe.imports(/mscoree.dll/i, /_CorExeMain/) 
	or 	pe.imports(/mscoree.dll/i, /_corexemain/) 
	or 	pe.imports(/mscoree.dll/i, /_CorDllMain/) 
	or 	pe.imports(/mscoree.dll/i, /_cordllmain/)  ) 
}
...
private rule capa_add_file_to_cabinet_file { 
 ...
 ( 	pe.imports(/cabinet.dll/i, /FCIAddFile/)  ) 
}
...
private rule capa_get_file_size { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /GetFileSize/) 
	or 	pe.imports(/kernel32.dll/i, /GetFileSizeEx/)  ) 
}
...
private rule capa_open_cabinet_file { 
 ...
 ( 	pe.imports(/cabinet.dll/i, /FCICreate/)  ) 
}
...
private rule capa_get_service_handle { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /CreateService/) 
	or 	pe.imports(/advapi32.dll/i, /OpenService/)  ) 
}
...
private rule capa_listen_for_remote_procedure_calls { 
 ...
 ( 	pe.imports(/rpcrt4.dll/i, /RpcServerListen/)  ) 
}
...
private rule capa_enumerate_internet_cache { 
 ...
 ( 	pe.imports(/wininet.dll/i, /FindFirstUrlCacheEntry/)  ) 
}
...
private rule capa_get_networking_parameters { 
 ...
 ( 	pe.imports(/iphlpapi.dll/i, /GetNetworkParams/)  ) 
}
...
private rule capa_get_file_version_info { 
 ...
 (  (  ( 	pe.imports(/version.dll/i, /GetFileVersionInfo/) 
	or 	pe.imports(/version.dll/i, /GetFileVersionInfoEx/)  )  )  ) 
}
...
private rule capa_get_token_membership { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /CheckTokenMembership/)  ) 
}
...
private rule capa_get_thread_local_storage_value { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /TlsGetValue/)  ) 
}
...
private rule capa_enumerate_threads { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /Thread32First/) 
	and 	pe.imports(/kernel32.dll/i, /Thread32Next/)  ) 
}
...
private rule capa_decrypt_data_via_SSPI { 
 ...
 ( 	pe.imports(/secur32.dll/i, /DecryptMessage/)  ) 
}
...
private rule capa_compare_security_identifiers { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /EqualSid/)  ) 
}
...
private rule capa_query_remote_server_for_available_data { 
 ...
 ( 	pe.imports(/wininet.dll/i, /InternetQueryDataAvailable/)  ) 
}
...
private rule capa_initialize_hashing_via_WinCrypt { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /CryptCreateHash/)  ) 
}
...
private rule capa_encrypt_data_via_SSPI { 
 ...
 ( 	pe.imports(/secur32.dll/i, /EncryptMessage/)  ) 
}
...
private rule capa_get_system_firmware_table { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /GetSystemFirmwareTable/)  ) 
}
...
private rule capa_get_socket_information { 
 ...
 ( 	pe.imports(/ws2_32.dll/i, /getsockname/)  ) 
}
...
private rule capa_create_Restart_Manager_session { 
 ...
 ( 	pe.imports(/rstrtmgr.dll/i, /RmStartSession/)  ) 
}
...
private rule capa_impersonate_user { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /LogonUser/) 
	or  (  ( 	pe.imports(/userenv.dll/i, /LoadUserProfile/)  )  )  ) 
}
...
private rule capa_get_user_security_identifier { 
 ...
 ( 	pe.imports(/advapi32.dll/i, /LookupAccountName/) 
	or 	pe.imports(/advapi32.dll/i, /LsaLookupNames/) 
	or 	pe.imports(/advapi32.dll/i, /LsaLookupNames2/)  ) 
}
...
private rule capa_flush_cabinet_file { 
 ...
 ( 	pe.imports(/cabinet.dll/i, /FCIFlushFolder/) 
	or 	pe.imports(/cabinet.dll/i, /FCIFlushCabinet/)  ) 
}
...
private rule capa_enumerate_system_firmware_tables { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /EnumSystemFirmwareTables/)  ) 
}
...
private rule capa_connect_network_resource { 
 ...
 (  (  ( 	pe.imports(/mpr.dll/i, /WNetAddConnection/) 
	or 	pe.imports(/mpr.dll/i, /WNetAddConnection2/) 
	or 	pe.imports(/mpr.dll/i, /WNetAddConnection3/)  )  )  ) 
}
...
private rule capa_set_console_window_title { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /SetConsoleTitle/)  ) 
}
...
private rule capa_get_routing_table { 
 ...
 ( 	pe.imports(/iphlpapi.dll/i, /GetIpForwardTable/) 
	or 	pe.imports(/iphlpapi.dll/i, /GetIpForwardTable2/)  ) 
}
...
private rule capa_delete_internet_cache { 
 ...
 ( 	capa_enumerate_internet_cache
	...
	and 	pe.imports(/wininet.dll/i, /DeleteUrlCacheEntry/)  ) 
}
...
private rule capa_read_process_memory { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /ReadProcessMemory/)  ) 
}
...
private rule capa_compiled_from_EPL { 
 ...
 ( 	$str_bdg 
	...
	or 	pe.imports(/krnln.dll/i, /fne/) 
	or 	pe.imports(/krnln.dll/i, /fnr/) 
	or 	pe.imports(/eAPI.dll/i, /fne/) 
	or 	pe.imports(/RegEx.dll/i, /fnr/)  ) 
}
...
private rule capa_get_session_information { 
 ...
 ( 	pe.imports(/wtsapi32.dll/i, /WTSQuerySessionInformation/)  ) 
}
...
private rule capa_compiled_from_Visual_Basic { 
 ...
 ( 	$bdw 
	and 	pe.imports(/msvbvm60.dll/i, /ThunRTMain/)  ) 
}
...
private rule capa_compiled_with_Borland_Delphi { 
 ...
 ( 	$str_beu 
	...
	or 	$str_bew 
	or 	$str_bex 
	or 	pe.imports(/BORLNDMM.dll/i, /DLL/)  ) 
}
...
private rule capa_reference_NCR_ATM_library_routines { 
 ...
 ( 	$str_bfi 
	or 	pe.imports(/msxfs.dll/i, /WFSCleanUp/) 
	or 	$str_bfj 
	or 	pe.imports(/msxfs.dll/i, /WFSClose/) 
	or 	$str_bfk 
	or 	pe.imports(/msxfs.dll/i, /WFSExecute/) 
	or 	$str_bfl 
	or 	pe.imports(/msxfs.dll/i, /WFSFreeResult/) 
	or 	$str_bfm 
	or 	pe.imports(/msxfs.dll/i, /WFSGetInfo/) 
	or 	$str_bfn 
	or 	pe.imports(/msxfs.dll/i, /WFSLock/) 
	or 	$str_bfo 
	or 	pe.imports(/msxfs.dll/i, /WFSOpen/) 
	or 	$str_bfp 
	or 	pe.imports(/msxfs.dll/i, /WFSRegister/) 
	or 	$str_bfq 
	or 	pe.imports(/msxfs.dll/i, /WFSStartUp/) 
	or 	$str_bfr 
	or 	pe.imports(/msxfs.dll/i, /WFSUnlock/) 
	or 	$str_bfs  ) 
}
...
private rule capa_load_Diebold_Nixdorf_ATM_library { 
 ...
 ( 	pe.imports(/cscwcng.dll/i, /dll/) 
	or 	$str_bfv 
	or 	pe.imports(/cscwcng.dll/i, /CscCngStatusWrite/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngCasRefInit/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngEncryption/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngRecovery/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngService/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngOpen/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngReset/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngClose/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngDispense/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngTransport/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngStatusRead/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngInit/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngGetRelease/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngLock/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngUnlock/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngShutter/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngPowerOff/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngSelStatus/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngBim/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngConfigure/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngStatistics/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngControl/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngPsm/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngGetTrace/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngOptimization/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngSelftest/) 
	or 	pe.imports(/cscwcng.dll/i, /CscCngEco/) 
	or 	$str_bfw 
	or 	$str_bfx 
	or 	$str_bfy 
	or 	$str_bfz 
...
private rule capa_initialize_WinHTTP_library { 
 ...
 ( 	pe.imports(/winhttp.dll/i, /WinHttpOpen/)  ) 
}
...
private rule capa_set_HTTP_header { 
 ...
 ( 	pe.imports(/winhttp.dll/i, /WinHttpAddRequestHeaders/)  ) 
}
...
private rule capa_read_HTTP_header { 
 ...
 ( 	pe.imports(/winhttp.dll/i, /WinHttpQueryHeaders/)  ) 
}
...
private rule capa_send_HTTP_response { 
 ...
 ( 	pe.imports(/httpapi.dll/i, /HttpSendHttpResponse/)  ) 
}
...
private rule capa_start_HTTP_server { 
 ...
 ( 	pe.imports(/httpapi.dll/i, /HttpInitialize/)  ) 
}
...
private rule capa_receive_HTTP_response { 
 ...
 ( 	pe.imports(/winhttp.dll/i, /WinHttpReceiveResponse/) 
	or  (  ( 	pe.imports(/winhttp.dll/i, /WinHttpReadData/)  )  )  ) 
}
...
private rule capa_create_HTTP_request { 
 ...
 ( 	pe.imports(/wininet.dll/i, /InternetOpen/)  ) 
}
...
private rule capa_connect_to_URL { 
 ...
 ( 	pe.imports(/wininet.dll/i, /InternetOpenUrl/)  ) 
}
...
private rule capa_send_file_via_HTTP { 
 ...
 ( 	pe.imports(/wininet.dll/i, /InternetWriteFile/)  ) 
}
...
private rule capa_download_URL_to_file { 
 ...
 ( 	pe.imports(/urlmon.dll/i, /URLDownloadToFile/) 
	or 	pe.imports(/urlmon.dll/i, /URLDownloadToCacheFile/)  ) 
}
...
private rule capa_send_HTTP_request { 
 ...
 (  (  (  (  ( 	pe.imports(/wininet.dll/i, /HttpOpenRequest/) 
	or 	pe.imports(/wininet.dll/i, /InternetConnect/)  )  ) 
	and  (  ( 	pe.imports(/wininet.dll/i, /HttpSendRequest/) 
	or 	pe.imports(/wininet.dll/i, /HttpSendRequestEx/)  )  )  )  ) 
	or  (  ( 	pe.imports(/winhttp.dll/i, /WinHttpSendRequest/) 
	and 	pe.imports(/winhttp.dll/i, /WinHttpWriteData/)  )  ) 
  ) 
}
...
private rule capa_prepare_HTTP_request { 
 ...
 ( 	pe.imports(/winhttp.dll/i, /WinHttpOpenRequest/)  ) 
}
...
private rule capa_read_data_from_Internet { 
 ...
 (  (  ( 	pe.imports(/wininet.dll/i, /InternetReadFile/) 
	or 	pe.imports(/wininet.dll/i, /InternetReadFileEx/)  )  )  ) 
}
...
private rule capa_connect_to_HTTP_server { 
 ...
 ( 	pe.imports(/wininet.dll/i, /InternetConnect/)  ) 
}
...
private rule capa_send_file_using_FTP_via_wininet { 
 ...
 ( 	pe.imports(/wininet.dll/i, /FtpPutFile/)  ) 
}
...
private rule capa_initialize_Winsock_library { 
 ...
 ( 	pe.imports(/ws2_32.dll/i, /WSAStartup/)  ) 
}
...
private rule capa_get_socket_status { 
 ...
 ( 	pe.imports(/ws2_32.dll/i, /select/)  ) 
}
...
private rule capa_set_socket_configuration { 
 ...
 ( 	pe.imports(/ws2_32.dll/i, /setsockopt/) 
	or 	pe.imports(/ws2_32.dll/i, /ioctlsocket/)  ) 
}
...
private rule capa_receive_data_on_socket { 
 ...
 ( 	pe.imports(/ws2_32.dll/i, /recv/) 
	or 	pe.imports(/ws2_32.dll/i, /recvfrom/) 
	or 	pe.imports(/ws2_32.dll/i, /WSARecv/) 
	or 	pe.imports(/ws2_32.dll/i, /WSARecvDisconnect/) 
	or 	pe.imports(/ws2_32.dll/i, /WSARecvEx/) 
	or 	pe.imports(/ws2_32.dll/i, /WSARecvFrom/) 
	or 	pe.imports(/ws2_32.dll/i, /WSARecvMsg/)  ) 
}
...
private rule capa_send_data_on_socket { 
 ...
 ( 	pe.imports(/ws2_32.dll/i, /send/) 
	or 	pe.imports(/ws2_32.dll/i, /sendto/) 
	or 	pe.imports(/ws2_32.dll/i, /WSASend/) 
	or 	pe.imports(/ws2_32.dll/i, /WSASendMsg/) 
	or 	pe.imports(/ws2_32.dll/i, /WSASendTo/)  ) 
}
...
private rule capa_create_pipe { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /CreatePipe/) 
	or 	pe.imports(/kernel32.dll/i, /CreateNamedPipe/)  ) 
}
...
private rule capa_write_pipe { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /TransactNamedPipe/) 
	or 	pe.imports(/kernel32.dll/i, /CallNamedPipe/)  ) 
}
...
private rule capa_connect_pipe { 
 ...
 ( 	pe.imports(/kernel32.dll/i, /ConnectNamedPipe/) 
	or 	pe.imports(/kernel32.dll/i, /CallNamedPipe/)  ) 
}
...
private rule capa_read_pipe { 
 ...
 (  (  ( 	pe.imports(/kernel32.dll/i, /PeekNamedPipe/) 
	and 	pe.imports(/kernel32.dll/i, /ReadFile/)  )  ) 
	or 	pe.imports(/kernel32.dll/i, /TransactNamedPipe/) 
	or 	pe.imports(/kernel32.dll/i, /CallNamedPipe/)  ) 
}
...
private rule capa_log_keystrokes_via_polling { 
 ...
 ( 	pe.imports(/user32.dll/i, /GetAsyncKeyState/) 
	or 	pe.imports(/user32.dll/i, /GetKeyState/) 
	or 	pe.imports(/user32.dll/i, /GetKeyboardState/) 
	or 	pe.imports(/user32.dll/i, /VkKeyScan/) 
	or 	pe.imports(/user32.dll/i, /VkKeyScanEx/) 
	or 	pe.imports(/user32.dll/i, /GetKeyNameText/)  ) 
}
...
private rule capa_log_keystrokes { 
 ...
 (  (  ( 	pe.imports(/\w{1,20}\.dll/i, /SetWindowsHookEx/) 
	...
	or 	pe.imports(/user32.dll/i, /AttachThreadInput/) 
	or 	pe.imports(/user32.dll/i, /MapVirtualKey/)  ) 
}
...
private rule capa_capture_network_configuration_via_ipconfig { 
 ...
 ( 	$bid 
	and 	pe.imports(/msvcr100.dll/i, /system/)  ) 
}
...
private rule capa_create_reverse_shell { 
 ...
 (  (  ( 	capa_create_pipe
	...
	and 	pe.imports(/kernel32.dll/i, /PeekNamedPipe/) 
	and 	pe.imports(/kernel32.dll/i, /CreateProcess/) 
	and 	pe.imports(/kernel32.dll/i, /ReadFile/) 
	and 	pe.imports(/kernel32.dll/i, /WriteFile/)  )  ) 
	or  (  ( 	capa_create_process
...
private rule capa_check_mutex { 
 ...
 (  (  ( 	pe.imports(/kernel32.dll/i, /OpenMutex/) 
